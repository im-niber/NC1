...
//                .fill(self.colorScheme == .dark ? self.darkModeStyle.backgroundColor : self.style.backgroundColor)
            ...
            VStack(alignment: .leading){
                ...
                BarChartRow(data: data.points.map{$0.1},
                            accentColor: self.colorScheme == .dark ? self.style.accentColor : self.style.accentColor,
                            gradient: self.colorScheme == .dark ? self.style.gradientColor : self.style.gradientColor,
